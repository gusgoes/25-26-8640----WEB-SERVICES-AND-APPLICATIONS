...
- `project/docs/` - Project and API documentation
...
4. `project/docs/api/README.md` - API contract and examples
5. `project/docs/project/README.md` - Setup, run, and troubleshooting guide
